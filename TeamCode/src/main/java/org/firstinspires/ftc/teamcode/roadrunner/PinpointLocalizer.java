...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2757.56909252; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1872.55865091; // x position of the perpendicular encoder (in tick units)
    }
