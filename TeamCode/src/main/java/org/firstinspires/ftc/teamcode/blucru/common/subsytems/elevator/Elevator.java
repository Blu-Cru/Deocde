...
public class Elevator implements BluSubsystem, Subsystem {
    ...
    private static final double DOWN_POSITION_LEFT = 0.01;//TODO: find positions
    private static final double UP_POSITION_LEFT = 0.3;
    private static final double MIDDLE_POSITION_LEFT = 0.13;

    private static final double DOWN_POSITION_RIGHT = 0.99;//TODO: find positions
    private static final double UP_POSITION_RIGHT = 0.7;
    private static final double MIDDLE_POSITION_RIGHT = 0.87;
