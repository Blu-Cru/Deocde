...
public class TurretTwelveBallCloseAutoRedPathOnly extends BluLinearOpMode {
    ...
    public void initialize() {
        ...
        path = drive.actionBuilder(Globals.mapRRPose2d(startPose))
                ...
                .setReversed(false)
                .splineTo(new Vector2d(-27, 37), Math.toRadians(180))
                .waitSeconds(0.8)
                ...
                .splineTo(new Vector2d(-19, 32), Math.toRadians(180))
                .turnTo(Math.toRadians(180))
                .waitSeconds(1)
                ...
                .turnTo(Math.toRadians(180))
                .setReversed(true)
                .splineTo(new Vector2d(0, 43), Math.toRadians(90))
                .splineTo(new Vector2d(0, 55), Math.toRadians(90))
                .waitSeconds(1.5) // OPEN GATE
                ...
                .setReversed(false)
                .splineTo(new Vector2d(-22, 30), Math.toRadians(180))
                .waitSeconds(0.5)
                .turnTo(Math.toRadians(180))
