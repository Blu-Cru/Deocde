...
public class ShooterAutoAimInterpolation {
    ...
    private static final double[] leftAngles = {26, 26, 32, 34, 39, 41, 42, 42, 45, 46};
    private static final double[] middleAngles = {28, 28, 42, 44, 47, 48, 49, 50, 50, 50};
    private static final double[] rightAngles = {26, 26, 36, 38, 43, 45, 46, 47, 48, 50};
    private static final double[] velocities = {850, 850, 900, 1000, 1030, 1070, 1100, 1150, 1170, 1230};
