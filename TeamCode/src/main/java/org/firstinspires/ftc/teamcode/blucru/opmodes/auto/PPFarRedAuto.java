...
public class PPFarRedAuto extends BluLinearOpMode {
            ...
            this.addPurePursuitPath(new Point2d[]{
                    ...
                    .callback(() -> {
                        new SequentialCommandGroup(
                                ...
                                new AutonomousTransferCommand(leftHood, middleHood, rightHood, turretAngleRest+1)
                        ).schedule();
                    })
                    .waitMilliseconds(300)
                    .addPurePursuitPath(new Point2d[]{
                    ...
                    .callback(() -> {
                        new SequentialCommandGroup(
                                new SetShooterVelocityIndependentCommand(shootVeloLeft, shootVeloMiddle, shootVeloRight),
                                new AutonomousAntiJamTransferCommand(leftHood, middleHood, rightHood, turretAngleRest-1)
                        ).schedule();
                    })
                    .addPurePursuitPath(new Point2d[]{
                            new Point2d(62, pickupWallY),
                    ...
                    .callback(() -> {
                        new SequentialCommandGroup(
                                new SetShooterVelocityIndependentCommand(shootVeloLeft, shootVeloMiddle, shootVeloRight),
                                new AutonomousAntiJamTransferCommand(leftHood, middleHood, rightHood, turretAngleRest)
                        ).schedule();
                    })
                    .addPurePursuitPath(new Point2d[]{
                            new Point2d(62, pickupWallY),
    ...
    public void onStart() {
        ...
        turret.setAngle(turretAnglePreload);
