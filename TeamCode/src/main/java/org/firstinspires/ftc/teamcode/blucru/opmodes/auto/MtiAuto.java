...
public class MtiAuto extends BaseAuto {
    ...
    double farVeloLeft = 1470;
    double farVeloMiddle = 1470;
    double farVeloRight = 1470;
    double hoodFar = 49;
    double hood = 34;
...
//                    )
                    ...
                    .waitUntil(() -> shooter.hasShot(3), 1500)
...
//                    })
                    ...
                    .waitUntil(() -> turret.atTarget(),2500)
                    //small time for settling
                    .waitMilliseconds(50)
