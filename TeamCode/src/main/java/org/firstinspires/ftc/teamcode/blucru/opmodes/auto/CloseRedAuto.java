...
public class CloseRedAuto extends BaseAuto {
    ...
    private Point2d shootingPose = new Point2d(4, -10).mirror(141.5);
    ...
    public Pose2d getStartPose() {
        return new Pose2d(-52, -54, Math.toRadians(51.529)).mirror(141.5);
    }
    ...
    private Path buildPreloadPath() {
        return new SixWheelPIDPathBuilder()
                .addPurePursuitPath(new Point2d[] {
                        new Point2d(-52, -54).mirror(141.5),
                        new Point2d(-40, -41).mirror(141.5)
                }, 1000)
                .callback(() -> {
                    new SequentialCommandGroup(
    ...
    private Path buildSpikeMiddlePath() {
        return new SixWheelPIDPathBuilder()
                .addPurePursuitPath(new Point2d[] {
                        ...
                        new Point2d(-27.5, -25).mirror(141.5),
                        new Point2d(-15, -18).mirror(141.5),
                        new Point2d(3, -18).mirror(141.5),
                        new Point2d(10,-20).mirror(141.5),
                        new Point2d(12, -33).mirror(141.5),
                        new Point2d(12, -46).mirror(141.5),
                        new Point2d(7, -57).mirror(141.5),
                }, 3000)
//                        .waitMilliseconds(500)
                ...
                .addPurePursuitPath(new Point2d[] {
                        new Point2d(12, -55).mirror(141.5),
                        new Point2d(15, -52).mirror(141.5),
                        new Point2d(12,-30).mirror(141.5),
                        shootingPose
                }, 1500, true)
                .waitMilliseconds(500)
                .callback(() -> {
    ...
    private Path buildFirstIntakeCyclePath() {
        return new SixWheelPIDPathBuilder()
                .addPurePursuitPath(new Point2d[] {
                        shootingPose,
                        new Point2d(14, -45).mirror(141.5)
                }, 1000)
                .addPurePursuitPath(new Point2d[]{
                        new Point2d(14, -45).mirror(141.5),
                        new Point2d(13, -50).mirror(141.5),
                        new Point2d(10, -60).mirror(141.5)}, 700)
                .waitUntil(() -> elevator.isFull(),1500)
                .callback(() -> {
                    scheduleVelocityTransferThenLockOn(400, velo, veloMiddle, velo, hood);
                })
                .addPurePursuitPath(new Point2d[] {
                        new Point2d(9, -60).mirror(141.5),
                        new Point2d(15, -52).mirror(141.5),
                        new Point2d(12,-30).mirror(141.5),
                        shootingPose
                }, 2000, true)
...
//                .addTurnTo(-90,500)
    ...
    private Path buildSpikeClosePath() {
        return new SixWheelPIDPathBuilder()
                .addPurePursuitPath(new Point2d[] {
                        shootingPose,
                        new Point2d(-6, -34).mirror(141.5),
                        new Point2d(-11, -58).mirror(141.5)
                }, 1300)
                ...
                .addPurePursuitPath(new Point2d[] {
                        new Point2d(-15, -55).mirror(141.5),
//                        new Point2d(-6, -19).mirror(141.5),
                        new Point2d(-16,-15).mirror(141.5)
                }, 2000)
//                                .addTurnTo(-30, 1000)
                .waitMilliseconds(200)
    ...
    private Path buildSpikeFarPath() {
        return new SixWheelPIDPathBuilder()
                .addPurePursuitPath(new Point2d[] {
                        new Point2d(-16, -12).mirror(141.5),
                        new Point2d(32, -46).mirror(141.5),
                        new Point2d(39, -52).mirror(141.5),
...
//                                .waitMilliseconds(100)
                .addPurePursuitPath(new Point2d[] {
                        new Point2d(32, -48).mirror(141.5),
                        new Point2d(-4, -13).mirror(141.5)
                }, 2000)
