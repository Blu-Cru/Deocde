...
public class Globals {
    ...
    public static double turretTargetRedX = -59;
    public static double turretTargetRedY = 57;

    public static double turretTargetBlueX = -59;
    public static double turretTargetBlueY = -57;
