...
public class Globals {
    ...
    public static double turretTargetRedX = -58;
    public static double turretTargetRedY = 58;

    public static double turretTargetBlueX = -58;
    public static double turretTargetBlueY = -58;
