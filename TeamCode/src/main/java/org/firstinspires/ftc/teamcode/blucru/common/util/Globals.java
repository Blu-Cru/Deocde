...
public class Globals {
    ...
    // Into the Deep High Baskets (Corners)
    public static Vector2d shootingGoalLPose = new Vector2d(-72, 72);
    public static Vector2d shootingGoalRPose = new Vector2d(-72, -72);
